...
set title "Ring benchmark on 64 nodes (XT5)"
set logscale x 2
set logscale y 10
set key top left
...
plot "xt5.ring.ampi.64.out" using 1:($2*1e6) title "AMPI" with linespoints ls 2, \
"xt5.ring.mpi.64.out" using 1:($2*1e6) title "MPI" with linespoints ls 1
