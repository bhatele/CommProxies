...
set title "Ring benchmark on 64 nodes (Blue Gene/P)"
set logscale x 2
set logscale y 10
set key top left
set size 0.75,0.75
...
plot "bgp.ring.ampi.64.output" using 1:($2*1e6) title "AMPI" with linespoints ls 2, \
"bgp.ring.mpi.64.output" using 1:($2*1e6) title "MPI" with linespoints ls 1
